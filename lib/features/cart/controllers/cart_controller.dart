...
class CartController extends GetxController implements GetxService {
  ...
  List<String> notAvailableList = ['Remover do meu carrinho', 'Vou esperar até que esteja novamente em estoque', 'Por favor, cancele o pedido', 'Me ligue o mais rápido possível', 'Me avise quando estiver de volta'
];
