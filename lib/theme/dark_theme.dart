...
ThemeData dark = ThemeData(
  ...
  secondaryHeaderColor: Color(0x9BF0231C),
  ...
  colorScheme: const ColorScheme.dark(primary: Color(0xFFE74350),
    tertiary: Color(0xff6165D7),
    tertiaryContainer: Color(0xff171DB6),
    secondary: Color(0xFFE74350)).copyWith(surface: const Color(0xFF272727)).copyWith(error: const Color(0xFFdd3135),
  ),
